	...
	<div id="container">
		...
		<section id="centro">
			...
			<h1>Editar Parceiros</h1>
                        <form enctype="multipart/form-data" method="post" action="<?php echo base_url("parceiros/editar"); ?>">
                            <fieldset>
                                ...
                                <figure>
                                	<img src="<?php echo $this->base->base_adm("img/clientes/{$cliente->foto}");  ?>" alt="">
                                </figure>
                                <div class="separar">
                                <label>Logo:</label>
