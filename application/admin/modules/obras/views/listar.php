...
<body>
	...
	<div id="container">
		...
		<section id="centro">
			...
			<h1>Lista de Obras Cadastrados</h1>
			<a href="obras/cadastrar" class="cadastrar">Cadastrar</a>
			<table id="tbl-clientes">
				...
				<tbody id="tabela">
					...
					foreach ($lista->result() as $linha) {
						...
						<tr>
							<td>".$linha->titulo."</td>
							<td><img src='".$this->base->base_adm("img/obras/{$linha->imagem}")."' alt='' class='logo'></td>
							<td><a href='".base_url("obras/editar/{$linha->id}")."'><img src='{$this->base->base_adm("img/adm/editar-icon.png")}' alt=''></a></td>
							<td><a href='".  base_url("obras/excluir/{$linha->id}")."'><img src='{$this->base->base_adm("img/adm/excluir-icon.png")}' alt=''></a></td>
						</tr>";
					}
