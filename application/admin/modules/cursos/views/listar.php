...
<body>
	...
	<div id="container">
		...
		<section id="centro">
			...
			<a href="cursos/cadastrar" class="cadastrar">Cadastrar</a>
			<table id="tbl-clientes">
				...
				<tbody id="tabela">
					...
					foreach ($lista->result() as $linha) {
						...
						<tr>
							<td>".$linha->curso."</td>
							<td><a href='".base_url("cursos/editar/{$linha->id}")."'><img src='{$this->base->base_adm("img/adm/editar-icon.png")}' alt=''></a></td>
							<td><a href='".  base_url("cursos/excluir/{$linha->id}")."'><img src='{$this->base->base_adm("img/adm/excluir-icon.png")}' alt=''></a></td>
						</tr>";
					}
