...
<body>
	...
	<div id="container">
		...
		<section id="centro">
			...
			<h1>Editar Topicos</h1>
                        <form enctype="multipart/form-data" method="post" action="<?php echo base_url("topicos/editar"); ?>">
                            <fieldset>
                                ...
                                <figure>
                                    <img src="<?php echo $this->base->base_adm("img/topicos/{$cliente->imagem}");  ?>" alt="">
                                </figure>
                                <div class="separar">
