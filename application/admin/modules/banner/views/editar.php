...
<body>
	...
	<div id="container">
		...
		<section id="centro">
			...
			<h1>Editar Banner</h1>
                        <form enctype="multipart/form-data" method="post" action="<?php echo base_url("banner/editar"); ?>">
                            <fieldset>
                                ...
                                <figure>
                                	<img src="<?php echo $this->base->base_adm("img/banners/{$cliente->img}");  ?>" width="200px" height="auto" alt="">
                                </figure>
                                <div class="separar">
                                <label>Logo:</label>
