...
<body>
	...
	<div id="container">
		...
		<section id="centro">
			...
			<h1>Lista de Banners Cadastrados</h1>
			<a href="banner/cadastrar" class="cadastrar">Cadastrar</a>
			<table id="tbl-clientes">
				...
				<tbody id="tabela">
					...
					foreach ($lista->result() as $linha) {
						echo "
						<tr>
							<td><img src='{$this->base->base_adm("img/banners/{$linha->img}")}' alt='' width='200px' height='auto' style='display:inline-block;margin-top:10px'></td>
							<td><a href='".base_url("banner/editar/{$linha->id}")."'><img src='{$this->base->base_adm("img/adm/editar-icon.png")}' alt=''></a></td>
							<td><a href='".  base_url("banner/excluir/{$linha->id}")."'><img src='{$this->base->base_adm("img/adm/excluir-icon.png")}' alt=''></a></td>
						</tr>";
					}
