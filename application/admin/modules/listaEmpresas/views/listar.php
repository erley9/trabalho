...
<body>
	...
	<div id="container">
		...
		<section id="centro">
			...
			<a href="listaEmpresas/cadastrar" class="cadastrar">Cadastrar</a>
			<form action="<?php echo base_url("listaEmpresas/buscar"); ?>" id="buscaCodigo" method="post">
				<input type="text" name="busca" id="busca" placeholder="Digite o nome da empresa">
			...
			<table id="tbl-clientes">
				...
				<tbody id="tabela">
					...
					foreach ($lista->result() as $linha) {
						...
						<tr>
							<td>".$linha->nome."</td>
							<td><a href='".base_url("listaEmpresas/editar/{$linha->id}")."'><img src='{$this->base->base_adm("img/adm/editar-icon.png")}' alt=''></a></td>
							<td><a href='".  base_url("listaEmpresas/excluir/{$linha->id}")."'><img src='{$this->base->base_adm("img/adm/excluir-icon.png")}' alt=''></a></td>
						</tr>";
					}
