...
<body>
	...
	<div id="container">
		...
		<section id="centro">
			...
			<h1>Lista de Faixa Salarial</h1>
			<a href="faixas/cadastrar" class="cadastrar">Cadastrar</a>
			...
			<colgroup>
				...
				<tbody id="tabela">
					...
					foreach ($lista->result() as $linha) {
						...
						<tr>
							<td>".$linha->valor."</td>
							<td><a href='".base_url("faixas/editar/{$linha->id}")."'><img src='{$this->base->base_adm("img/adm/editar-icon.png")}' alt=''></a></td>
							<td><a href='".  base_url("faixas/excluir/{$linha->id}")."'><img src='{$this->base->base_adm("img/adm/excluir-icon.png")}' alt=''></a></td>
						</tr>";
					}
