...
<body>
	...
	<div id="container">
		...
		<section id="centro">
			...
			<h1>Lista de Tipos de Contratações</h1>
			<a href="contratacoes/cadastrar" class="cadastrar">Cadastrar</a>
			...
			<colgroup>
				...
				<tbody id="tabela">
					...
					foreach ($lista->result() as $linha) {
						...
						<tr>
							<td>".$linha->tipo."</td>
							<td><a href='".base_url("contratacoes/editar/{$linha->id}")."'><img src='{$this->base->base_adm("img/adm/editar-icon.png")}' alt=''></a></td>
							<td><a href='".  base_url("contratacoes/excluir/{$linha->id}")."'><img src='{$this->base->base_adm("img/adm/excluir-icon.png")}' alt=''></a></td>
						</tr>";
					}
