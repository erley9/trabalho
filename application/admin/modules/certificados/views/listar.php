...
<body>
	...
	<div id="container">
		...
		<section id="centro">
			...
			<h1>Lista de Certificados Cadastrados</h1>
			<a href="certificados/cadastrar" class="cadastrar">Cadastrar</a>
			<table id="tbl-clientes">
				...
				<tbody id="tabela">
					...
					foreach ($lista->result() as $linha) {
						...
						<tr>
							<td>".$linha->titulo."</td>
							<td><img src='".$this->base->base_adm("img/certificados/{$linha->imagem}")."' alt='' class='logo'></td>
							<td><a href='".base_url("certificados/editar/{$linha->id}")."'><img src='{$this->base->base_adm("img/adm/editar-icon.png")}' alt=''></a></td>
							<td><a href='".  base_url("certificados/excluir/{$linha->id}")."'><img src='{$this->base->base_adm("img/adm/excluir-icon.png")}' alt=''></a></td>
						</tr>";
					}
