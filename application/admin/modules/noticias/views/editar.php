	...
	<div id="container">
		...
		<section id="centro">
			...
			<h1>Editar Noticias</h1>
                        <form enctype="multipart/form-data" method="post" action="<?php echo base_url("noticias/editar"); ?>">
                            <fieldset>
                                ...
                                <div class="separar">
                                    <figure>
                                        <img src="<?php echo $this->base->base_adm("img/noticias/{$cliente->imagem}") ?>"  alt="" style="margin-bottom:10px">
                                    </figure>
                                    <label>Imagem:</label>
