...
<body>
	...
	<div id="container">
		...
		<section id="centro">
			...
			<h1>Editar Banner</h1>
                        <form enctype="multipart/form-data" method="post" action="<?php echo base_url("instrutores/editar"); ?>">
                            <fieldset>
                                ...
                                <figure>
                                	<img src="<?php echo $this->base->base_adm("img/instrutores/{$cliente->foto}");  ?>" alt="">
                                </figure>
