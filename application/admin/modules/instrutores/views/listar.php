...
<body>
	...
	<div id="container">
		...
		<section id="centro">
			...
			<h1>Lista de Instrutores Cadastrados</h1>
			<a href="instrutores/cadastrar" class="cadastrar">Cadastrar</a>
			<table id="tbl-clientes">
				...
				<tbody id="tabela">
					...
					foreach ($lista->result() as $linha) {
						...
						<tr>
							<td>$linha->nome</td>
							<td><a href='".base_url("instrutores/editar/{$linha->id}")."'><img src='{$this->base->base_adm("img/adm/editar-icon.png")}' alt=''></a></td>
							<td><a href='".  base_url("instrutores/excluir/{$linha->id}")."'><img src='{$this->base->base_adm("img/adm/excluir-icon.png")}' alt=''></a></td>
						</tr>";
					}
