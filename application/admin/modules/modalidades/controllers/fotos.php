...
class Fotos extends CI_Controller {
    ...
    public function listarFotos($fotos){
        ...
        foreach ($fotos as $foto) {
            ...
            <li>
                <a href='".base_url("modalidades/fotos/excluir")."' class='excluir' data-id='".$foto->id."'>X</a>
                <a href='".$this->base->base_adm("img/modalidades/{$foto->normal}")."'  rel='galeria-grupo' >
                    <img src='".$this->base->base_adm("img/modalidades/miniaturas/{$foto->miniatura}")."' alt=''>
                </a>
            </li>
    ...
    public function cadastraFoto(){
        ...
        $image_upload_folder ='../img/modalidades/';
        ...
        if (!$this->upload->do_upload()) {
            ...
            $miniatura_source = "../img/modalidades/miniaturas/{$arquivo_info['file_name']}";
