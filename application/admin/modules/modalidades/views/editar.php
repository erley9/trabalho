	...
	<div id="container">
		...
		<section id="centro">
			...
			<h1>Editar Modalidades</h1>
                        <form enctype="multipart/form-data" method="post" action="<?php echo base_url("modalidades/editar"); ?>">
                            <fieldset>
                                ...
                                <figure>
                                    <img src="<?php echo $this->base->base_adm("img/modalidades/{$cliente->imagem}");  ?>" alt="">
                                </figure>
                                <div class="separar">
