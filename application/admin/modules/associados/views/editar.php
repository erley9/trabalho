	...
	<div id="container">
		...
		<section id="centro">
			...
			<h1>Editar Associados</h1>
                        <form enctype="multipart/form-data" method="post" action="<?php echo base_url("associados/editar"); ?>">
                            <fieldset>
                                ...
                                <figure>
                                	<img src="<?php echo $this->base->base_adm("img/associados/{$cliente->img}");  ?>" alt="">
                                </figure>
                                <div class="separar">
                                <label>Logo:</label>
