...
<body>
	...
	<div id="container">
		...
		<section id="centro">
			...
			<h1>Editar Banner</h1>
                        <form enctype="multipart/form-data" method="post" action="<?php echo base_url("instalacoes/editar"); ?>">
                            <fieldset>
                            	...
                            	<div class="separar">
                            		...
                            		<textarea name="descricao" id="" cols="30" rows="10"><?php echo $cliente->descricao; ?></textarea>
                            	</div>

                                <figure>
                                	<img src="<?php echo $this->base->base_adm("img/instalacoes/{$cliente->foto}");  ?>" alt="">
                                </figure>
