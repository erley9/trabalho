  ...
  return false;
	...
	$("#form-dados-cliente").validate({
			...
			messages: {
				...
				sexo:"Por favor selecione seu sexo",
				cpf:{
				...
				descricao:"Fale um pouco sobre você",
				faixa:"Selecione a faixa de salario desejada",
				periodo:"Selecione o periodo que deseja trabalhar",
